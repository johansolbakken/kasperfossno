...
for (let i = 0; i < filer.length; i++) {
    ...
    let title = filer[i][0].toUpperCase() + filer[i].slice(1, filer[i].length);
    if (title == "Index") {
        title = "Hjem";
    }
...
footer_bottom.innerHTML = "&copy; kasperfoss.no | Designed by Johan, Ådne, Eivind, Thomas and Kasper";
